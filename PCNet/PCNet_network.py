...
def main():
    ...
    # DATAFRAMES
    df_links = csv_to_dataframe(path_csv=csv_path, type_of_df='links')
    df_nodes = csv_to_dataframe(path_csv=csv_path, type_of_df='nodes', columns=info)

    # GRAPH
    graph = df_to_graph(df_links, df_nodes, connected_graph=connected, unknown_nodes=keep_unknown_nodes)
